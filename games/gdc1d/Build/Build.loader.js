      ...
      require: function (e) {
        var t = {
          ...
          "zlib/inflate.js": function (e, t, n) {
            ...
            function i(e) {
              ...
              return e && e.state
                ? ((t = e.state),
                  ...
                  (t.hold = 0),
                  (t.bits = 0),
                  (t.lencode = t.lendyn = new v.Buf32(me)),
                  (t.distcode = t.distdyn = new v.Buf32(be)),
                  (t.sane = 1),
                  (t.back = -1),
                  R)
                : A;
            ...
            function u(e) {
              if (we) {
                var t;
                for (
                  b = new v.Buf32(512), g = new v.Buf32(32), t = 0;
                  t < 144;
                ...
                for (
                  ...
                  e.lens[t++] = 5;
                x(E, e.lens, 0, 32, g, 0, e.work, { bits: 5 }), (we = !1);
              }
              (e.lencode = b),
                (e.lenbits = 9),
                (e.distcode = g),
            ...
            function c(e, t, n, r) {
              ...
              return (
                null === i.window &&
                  ...
                  (i.wnext = 0),
                  (i.whave = 0),
                  (i.window = new v.Buf8(i.wsize))),
                r >= i.wsize
                  ? (v.arraySet(i.window, t, n - i.wsize, i.wsize, 0),
                    (i.wnext = 0),
                    (i.whave = i.wsize))
                  : ((a = i.wsize - i.wnext),
                    a > r && (a = r),
                    v.arraySet(i.window, t, n - r, a, i.wnext),
                    (r -= a),
                    r
                      ? (v.arraySet(i.window, t, n - r, r, 0),
                        (i.wnext = r),
                        (i.whave = i.wsize))
                      : ((i.wnext += a),
                ...
                switch (n.mode) {
                    ...
                    if (
                      ...
                      b &&
                        (n.head &&
                          ...
                          v.arraySet(n.head.extra, a, o, b, xe)),
                  ...
                  case ee:
                    for (; n.have < n.ncode; ) {
                      ...
                      (n.lens[Le[n.have++]] = 7 & f), (f >>>= 3), (h -= 3);
                    }
                    for (; n.have < 19; ) n.lens[Le[n.have++]] = 0;
                    if (
                      ((n.lencode = n.lendyn),
                      (n.lenbits = 7),
                      (Se = { bits: n.lenbits }),
                  ...
                  case ie:
                    for (
                      ;
                      (Be = n.distcode[f & ((1 << n.distbits) - 1)]),
                        (be = Be >>> 24),
                        (ge = (Be >>> 16) & 255),
                        (ve = 65535 & Be),
                        !(be <= h);
                    ...
                    (n.offset = ve), (n.extra = 15 & ge), (n.mode = oe);
                  case oe:
                    if (n.extra) {
                      for (Ee = n.extra; h < Ee; ) {
                        if (0 === l) break e;
                  ...
                  : ((p -= e.avail_in),
                    ...
                    n.wrap &&
                      ...
                      (e.adler = n.check = n.flags
                        ...
                        : w(n.check, i, m, e.next_out - m)),
                    (e.data_type =
                      n.bits +
                      (n.last ? 64 : 0) +
                      (n.mode === K ? 128 : 0) +
                      (n.mode === ne || n.mode === Q ? 256 : 0)),
                    ((0 === p && 0 === m) || t === B) && _e === R && (_e = T),
                    _e)
              );
            }
            function h(e) {
          ...
          "zlib/inftrees.js": function (e, t, n) {
            ...
            t.exports = function (e, t, n, p, m, b, g, v) {
              var w,
                y,
                k,
                x,
              ...
              for (I = L, A = a; A >= 1 && 0 === j[A]; A--);
              if ((I > A && (I = A), 0 === A))
                return (
                  (m[b++] = 20971520), (m[b++] = 20971520), (v.bits = 1), 0
                );
              for (U = 1; U < A && 0 === j[U]; U++);
